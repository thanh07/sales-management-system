                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-4 shrink-0 text-right">
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold ${isLowStock ? 'bg-red-500/20 text-red-400' : 'bg-emerald-500/20 text-emerald-300'}`}>
                        Tồn: {currBranchStock} {p.unit}
                      </span>
